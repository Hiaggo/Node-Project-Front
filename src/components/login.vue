        ...
        <v-layout align-center justify-center>
          <v-flex xs12 sm8 md4>
            <v-card flat id="wrapper" color="transparent">
              ...
              <v-card-text
                class="text1 text-xs-center"
              >The blood you donate gives someone another chance at life.</v-card-text>
              ...
              <v-layout justify-space-between>
                <v-flex md4 xs12>
                  <v-card color="transparent" flat>
                    ...
                    <v-card-text class="footer_text text-xs-left pt-0">
                ...
                <v-flex md4 xs12>
                  <v-card color="transparent" flat>
                    ...
                    <v-card-text
                      class="footer_text text-xs-left pt-0"
...
export default {
  ...
  methods: {
    login() {
      const self = this;
      const LOGIN_ENDPOINT = "http://localhost:3000/api/user/login";
